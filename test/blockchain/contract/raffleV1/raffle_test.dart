...
Future<String> _getFtBalanceAmount(
  ...
  return balance['amount'] as String;
}
...
Future<void> _enterRaffleFtAndExpect(
  TwoFinanceBlockchain c, {
  ...
  final event = unmarshalEvent<JsonMap>(
    log.event,
    (json) => Map<String, dynamic>.from(json as Map),
  );
...
void main() {
  group('RaffleV1 E2E', () {
    test('E2E: deploy raffle contract + addRaffle + getRaffle', () async {
      ...
      final ownerPrizeBeforeAdd = await _getFtBalanceAmount(
        c,
      ...
      final rafflePrizeAfterAdd = await _getFtBalanceAmount(
        c,
        tokenAddress: prizeTokenAddress,
      ...
      final ownerPrizeAfterAdd = await _getFtBalanceAmount(
        c,
        tokenAddress: prizeTokenAddress,
        ownerAddress: ownerUser.publicKey,
      );
      ...
      final player1PayBeforeEnter = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: player1User.publicKey,
      );

      final player2PayBeforeEnter = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: player2User.publicKey,
      );

      await _enterRaffleFtAndExpect(
        c,
        user: player1User,
        raffleAddress: raffleAddress,
      ...
      final player1PayAfterEnter = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: player1User.publicKey,
      );

      final player2PayAfterEnter = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: player2User.publicKey,
      );

      final rafflePayAfterEnter = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: raffleAddress,
      );
      ...
      final rafflePrizeBeforeClaim = await _getFtBalanceAmount(
        c,
        tokenAddress: prizeTokenAddress,
        ownerAddress: raffleAddress,
      );
      ...
      final winnerPrizeAfter = await _getFtBalanceAmount(
        c,
        tokenAddress: prizeTokenAddress,
        ownerAddress: winner,
      );
      ...
      final ownerPayBeforeWithdraw = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: ownerUser.publicKey,
      );

      final rafflePayBeforeWithdraw = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: raffleAddress,
      );
      ...
      final ownerPayAfterWithdraw = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: ownerUser.publicKey,
      );

      final rafflePayAfterWithdraw = await _getFtBalanceAmount(
        c,
        tokenAddress: paymentTokenAddress,
        ownerAddress: raffleAddress,
      );
